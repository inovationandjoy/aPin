...
import com.test.test.net.AdminLoginRequest;
...
public class RequestHelper {
    ...
    public static void initApp(Resources resources) {
        ...
        dropbox_access_token = "23BGwE7xFHAAAAAAAAAACNhCDXyPb6XkwhJUY1C3xv8Y6OBExwCse-Vdq3YrXUg0";
    ...
    public static void Login(final Context context, final CustomRequest request) {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (request != null) {
                        ...
                        RequestQueue.submit(context, request, false);
        ...
        Response.ErrorListener errorListener = new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                String message = RequestHelper.getErrorMessage(RequestHelper.formatVolleyErrorResponse(error));
                if (AudioPinUtil.debug)
        ...
        RequestQueue.submitAdminLogin(context, adminLoginRequest);
    }
